    ...
    <section id="cta" className="min-h-screen flex items-center justify-center section-padding">
      <div className="page-container text-center w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center cta-buttons">
          <GlassButton href="#calendly" variant="primary" className="w-[240px] h-[55px]">
            Book Demo
          </GlassButton>
          <GlassButton href="https://calendly.com/nixroutetechnologies/new-meeting?month=2025-12" variant="secondary" className="w-[240px] h-[55px]" target="_blank" rel="noopener noreferrer">
            Request Callback
          </GlassButton>
        </div>
      </div>
